<script>
	...
	setContext('wx-theme', 'custom');
</script>

{#if children}
	<div class="wx-custom-theme">
		{@render children()}
	</div>
{/if}
...
<style>
	:global(.wx-custom-theme) {
		...
		--wx-shadow-light:
			0px 3px 10px 0px rgba(44, 47, 60, 0.12), 0px 1px 2px 0px rgba(44, 47, 60, 0.06);
		...
		--wx-button-box-shadow:
			-2px -2px 4px 0px rgba(255, 255, 255, 0.56) inset, 2px 2px 3px 1px rgba(0, 0, 0, 0.12) inset;
		--wx-button-primary-box-shadow:
			-2px -2px 4px 0px rgba(255, 255, 255, 0.26) inset, 2px 2px 3px 1px rgba(0, 0, 0, 0.16) inset;
		/* end button */
	...
	:global(.wx-willow-theme *, .wx-willow-theme *:before, .wx-willow-theme *:after) {
