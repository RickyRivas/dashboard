    ...
    protected: [
        {
            ...
            children: [
                ...
                { path: '/app/chatbot', name: 'Chatbot', iconPath: 'm21.92.24.041-.108v.214c4.641 12.215 9.395 17.056 21.828 21.615H21.96h21.83c-12.353 4.64-17.265 9.322-21.83 21.608l.001.486-.092-.24-.04.107-.001-.213C17.186 31.494 12.434 26.653 0 22.093c12.353-4.64 17.263-9.321 21.828-21.608V0l.092.24Z', showInNav: true },
                { path: '/app/builder', name: 'Builder', iconPath: 'M30.456 2.415c.876.634 1.2 1.783.803 2.785l-5.775 14.444h10.658c.994 0 1.878.619 2.217 1.554a2.362 2.362 0 0 1-.707 2.615L16.44 41.49a2.357 2.357 0 0 1-3.698-2.688l5.775-14.444H7.858a2.354 2.354 0 0 1-2.217-1.554 2.362 2.362 0 0 1 .707-2.615L27.56 2.51a2.357 2.357 0 0 1 2.895-.096Z', showInNav: true },
                { path: '/app/sesame-builder', name: 'Sesame Builder', iconPath: 'M30.456 2.415c.876.634 1.2 1.783.803 2.785l-5.775 14.444h10.658c.994 0 1.878.619 2.217 1.554a2.362 2.362 0 0 1-.707 2.615L16.44 41.49a2.357 2.357 0 0 1-3.698-2.688l5.775-14.444H7.858a2.354 2.354 0 0 1-2.217-1.554 2.362 2.362 0 0 1 .707-2.615L27.56 2.51a2.357 2.357 0 0 1 2.895-.096Z', showInNav: true },
            ]
        },
        {
